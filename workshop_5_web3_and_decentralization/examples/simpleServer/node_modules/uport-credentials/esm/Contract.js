...
export var AbiEntryType;
(function (AbiEntryType) {
    AbiEntryType["Function"] = "function";
    AbiEntryType["Event"] = "event";
    AbiEntryType["Constructor"] = "constructor";
    AbiEntryType["Fallback"] = "fallback";
})(AbiEntryType || (AbiEntryType = {}));
var StateMutability;
...
const getCallableMethodsFromABI = (contractABI) => {
    return contractABI.filter((entry) => (entry.type === AbiEntryType.Function && entry.name && (!entry.constant)));
};
...
export const ContractFactory = (encoder) => (contractABI) => {
    return {
        at: (address) => {
            const functionCalls = {};
